...
Neural networks are black box optimizers, which inherently makes them difficult to design and difficult to understand. There's this unsettling pattern in deep learning research that I, as an outside observer have noticed. It goes like this:
